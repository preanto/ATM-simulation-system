...
public class SignUpThree extends JFrame implements ActionListener{
    ...
    SignUpThree(String formno)
    {
        ...
        l1.setFont(new Font("Ariel", Font.BOLD, 22));
        l1.setBounds(280,40,400,40);
        add(l1);
        
        JLabel type = new JLabel("Account Type");
        type.setFont(new Font("Ariel", Font.BOLD, 22));
        type.setBounds(100,140,200,30);
        add(type);
        
        r1 = new JRadioButton("Savings Account");
        r1.setFont (new Font("Ariel", Font.BOLD, 14));
        r1.setBackground(Color.WHITE);
        r1.setBounds(100, 180, 150,20);
        add(r1);
        
        
        r2 = new JRadioButton("Diposit Account");
        r2.setFont (new Font("Ariel", Font.BOLD, 14));
        r2.setBackground(Color.WHITE);
        r2.setBounds(350, 180, 150,20);
        add(r2);
        
        r3 = new JRadioButton("Current Account");
        r3.setFont (new Font("Ariel", Font.BOLD, 14));
        r3.setBackground(Color.WHITE);
        r3.setBounds(100, 220, 150,20);
        add(r3);
        
        r4 = new JRadioButton("Recurring Account");
        r4.setFont (new Font("Ariel", Font.BOLD, 14));
        ...
        card.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        carddetail.setFont(new Font("Ariel", Font.BOLD, 12));
        ...
        pindetail.setFont(new Font("Ariel", Font.BOLD, 12));
        pindetail.setBounds(100,400,300,20);
        add(pindetail);
        
        
        JLabel pnumber = new JLabel("XXXX");
        pnumber.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        c7.setFont(new Font("Ariel", Font.BOLD, 14));
        ...
        submit.setFont(new Font("Ariel", Font.BOLD, 14));
        ...
        cancel.setFont(new Font("Ariel", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==submit)
        {
            ...
            try 
            {
                ...
                setVisible(false);
                 new Diposit(pinnumber).setVisible(false);
                }
            }
            catch (Exception e)
                    {   
